...
def run_research_agent(topic: str, search_results: list[dict]) -> list[dict]:
    """
    ...
    prompt = f"""You are a research analyst. The user is researching: "{topic}"

Below are web sources collected about this topic. For EACH source, extract:
1. A 2-3 sentence summary
2. 2-4 bullet-point key facts or insights
